...
meta.model.tests <- function(){
    ...
    names.learn <- meta.model.learn(corpus, 4,"./project/test/sources/")
    names.load <- meta.model.load("./project/test/sources/")
    ...
    # Test.8 No ocurrances of any Ngram at all finded
